 ...
 * simba-turbo is deprecated. Use simba-multilingual instead. */
 | "simba-turbo";
export declare const GetStreamRequestModel: {
    readonly SimbaBase: "simba-base";
    readonly SimbaEnglish: "simba-english";
    readonly SimbaMultilingual: "simba-multilingual";
    readonly SimbaTurbo: "simba-turbo";
};
