...
const GetVoiceGender_1 = require("./GetVoiceGender");
const GetVoicesModel_1 = require("./GetVoicesModel");
const GetVoiceType_1 = require("./GetVoiceType");
exports.GetVoice = core.serialization.object({
    avatarImage: core.serialization.property("avatar_image", core.serialization.string().optionalNullable()),
    displayName: core.serialization.property("display_name", core.serialization.string()),
    gender: GetVoiceGender_1.GetVoiceGender,
    locale: core.serialization.string(),
    id: core.serialization.string(),
    models: core.serialization.list(GetVoicesModel_1.GetVoicesModel),
    ...
    type: GetVoiceType_1.GetVoiceType,
});
