...
const no_full_import_1 = __importDefault(require("../rules/no-full-import"));
const avaRuleTester = require('eslint-ava-rule-tester');
const ruleTester = avaRuleTester(ava_1.default, {
    env: {
        es6: true,
    },
    parserOptions: {
...
ruleTester.run('small-import/forbid-native-components', no_full_import_1.default, {
    invalid: [
        {
            code: 'import {max} from "lodash"',
            errors: [
                {
                    message: 'Import only this function instead of the whole lodash package',
                },
            ],
        ...
        },
        {
            ...
            errors: [
                {
                    message: 'Import only this function instead of the whole underscore package',
                },
            ],
        ...
        },
        {
            ...
            errors: [
                {
                    message: 'Import only this function instead of the whole date-fns package',
                },
            ],
        ...
        },
        {
            ...
            output: 'import sortBy from "lodash/sortBy";\nimport groupBy from "lodash/groupBy";\nimport max from "lodash/max";',
        },
    ],
    valid: [
